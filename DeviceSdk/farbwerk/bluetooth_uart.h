...
typedef struct
{
   ...
   int16_t data[3];		//output: data[0..3] in 1/100 percent range[0..10000] (R,G,B)
						//sensor: data[0]=sensor data   
   uint16_t crc;	    //crc, calculated from: type up to data[3]
}tFarberkUartReport;

//Samples
tFarberkUartReport sensor_set=
{
   0x01,             //start
